...
def main():
    ...
    if st.button("Analyze"):
        if documents:
            if selected_model == "LSA":
                ...
                display_results(topics, doc_term_matrix, explained_variance, topic_term_matrix, sparsity)
        else:
    ...
    if selected_result:
        ...
        display_results(result['topics'], result['doc_term_matrix'], result['explained_variance'], result['topic_term_matrix'], result['sparsity'])

def display_results(topics, doc_term_matrix, explained_variance, topic_term_matrix, sparsity):
